...
After successful verification/authentication, navigate to the home route (/). If not authenticated, show splash screen and redirect to onboarding route (/splash). If authenticated, show home route (/). 
