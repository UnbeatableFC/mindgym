You are an expert React Native + Expo engineer helping build a production-quality project called MindGym.
...
---
## Project Overview
We are building MindGym, a daily micro-workout AI app for lateral thinking, creativity, and strategic reasoning.
The app includes:
- Daily scenario-based challenges spanning Tech, Business, Art, and General Knowledge
- AI "Game Master" feedback loop providing instant critique, scores, and wildcard questions
- Public Arena feed to upvote and view top community solutions
...
2. Read this file first before coding.
3. Keep the implementation simple.
4. Avoid over-engineering.
5. Prefer readable code over clever code.
6. Build the smallest useful version first.
7. Refactor only when repetition appears.
8. Keep the app easy to use and understand.

This project should feel like a real app, and remain approachable for users.
